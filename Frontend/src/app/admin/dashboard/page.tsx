...
import { DollarSign, Users, ShoppingCart, Package, TrendingUp, Activity, Bell } from "lucide-react";
    ...
    <div className="text-gray-900 dark:text-gray-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="p-6 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm hover:shadow-md transition-shadow">
          ...
          <h3 className="font-medium text-gray-600 dark:text-gray-400 mb-1">Active Bookings</h3>
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{bookings.filter(b => b.status === 'accepted').length}</p>
        ...
        <div className="p-6 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm hover:shadow-md transition-shadow">
          ...
          <h3 className="font-medium text-gray-600 dark:text-gray-400 mb-1">Pending Bookings</h3>
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{bookings.filter(b => b.status === 'pending').length}</p>
        ...
        <div className="p-6 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm hover:shadow-md transition-shadow">
          ...
          <h3 className="font-medium text-gray-600 dark:text-gray-400 mb-1">Total Cars</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-6 shadow-sm">
            ...
            <div className="space-y-4">
              {isClient && bookings.slice(0, 5).map((booking, i) => {
                ...
                return (
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        New booking for {car?.make} {car?.model}
                        </p>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-6 shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Top Models</h3>
            <div className="space-y-3">
              {cars.slice(0,4).map((car, i) => (
                <div key={i} className="flex items-center justify-between py-2">
                  <span className="text-sm text-gray-600 dark:text-gray-400">{car.make} {car.model}</span>
