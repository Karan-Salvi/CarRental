...
const socialLinks = [
  ...
  { name: 'Instagram', href: '#', icon: <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.024.06 1.378.06 3.808s-.012 2.784-.06 3.808c-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.024.048-1.378.06-3.808.06s-2.784-.013-3.808-.06c-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.048-1.024-.06-1.378-.06-3.808s.012-2.784.06-3.808c.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772A4.902 4.902 0 016.08 2.525c.636-.247 1.363.416 2.427.465C9.53 2.013 9.884 2 12.315 2zm-1.16 4.706a4.524 4.524 0 100 9.048 4.524 4.524 0 000-9.048zM12 15.003a3.003 3.003 0 110-6.006 3.003 3.003 0 010 6.006zm5.338-9.87a1.187 1.187 0 100 2.373 1.187 1.187 0 000-2.373z" clipRule="evenodd" /></svg> },
];
    ...
    <footer className="bg-white border-t">
      <div className="container mx-auto px-4 pt-16 pb-8 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><Link href="/cars" className="text-sm text-muted-foreground hover:text-primary transition-colors">Browse Cars</Link></li>
              <li><Link href="#" className="text-sm text-muted-foreground hover:text-primary transition-colors">List Your Car</Link></li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><Link href="#" className="text-sm text-muted-foreground hover:text-primary transition-colors">Insurance</Link></li>
            </ul>
          </div>
           <div>
        ...
        <div className="mt-12 border-t pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-muted-foreground">
          <p>&copy; {isClient ? new Date().getFullYear() : ''} CarRental. All rights reserved.</p>
